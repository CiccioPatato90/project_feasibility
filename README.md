...
This solverProject uses Quarkus, the Supersonic Subatomic Java Framework.
...
You can then execute your native executable with: `./target/project_feasibility-1.0.0-SNAPSHOT-runner`
